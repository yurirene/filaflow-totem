...
from totem.printing import list_printers, print_test_file
...
class ConfigScreen(QWidget):
    ...
    def test_print(self):
        ...
        try:
            ...
            print_test_file(printer_name, content, os.path.dirname(get_config_path()))
            QMessageBox.information(
                self, "Sucesso", f"Comando de impressão enviado para: {printer_name}"
            )
        except Exception as e:
    ...
    def save_and_start(self):
        ...
        config = {"url": url, "printer": printer}
